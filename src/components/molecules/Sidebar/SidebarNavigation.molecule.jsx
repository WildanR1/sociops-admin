...
import { FaHome, FaChalkboardTeacher, FaCoins, FaHandHoldingHeart, FaArchive } from "react-icons/fa";

const SidebarNavigation = ({ currentPath }) => {
    const navItems = [
        { path: "/dashboard", icon: <FaHome size={24} />, label: "Dashboard" },
        { path: "/customer", icon: <FaChalkboardTeacher size={24} />, label: "Customer" },
        { path: "/fundraising", icon: <FaCoins size={24} />, label: "Fundraising" },
        { path: "/volunteer", icon: <FaHandHoldingHeart size={24} />, label: "Volunteer" },
